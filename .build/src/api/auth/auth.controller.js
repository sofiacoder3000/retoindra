...
const roles_decorators_1 = require("../../shared/decorators/roles.decorators");
...
let AuthController = class AuthController {
    ...
    async signUp(createUserDto) {
        const emailConflict = await this.usersService.findOne({
...
__decorate([
    ...
    roles_decorators_1.Roles('user', 'premium', 'admin'),
...
__decorate([
    common_1.Get('email-free/:email'),
    __param(0, common_1.Param()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "emailFree", null);
